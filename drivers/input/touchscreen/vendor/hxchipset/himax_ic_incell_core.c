...
#if defined(HX_SMART_WAKEUP) || defined(HX_HIGH_SENSE) || defined(HX_USB_DETECT_GLOBAL) || defined(HEADLINE_MODE)
static void himax_mcu_resend_cmd_func(bool suspended)
{
#if defined(HX_SMART_WAKEUP) || defined(HX_HIGH_SENSE) || defined(HEADLINE_MODE)
	struct himax_ts_data *ts = private_ts;
#endif
